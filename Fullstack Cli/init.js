...
function initializeApp() {
  ...
  switch (myArgs[1]) {
    //
    case "--all":
      //SEE HERE FOR EXAMPLE OF HOW TO LOG EVENT -- ALSO SEE LINE 9
      logEvents("createInit", "INFO", "all files created");
      createInit();
      createConfig();
  ...
  if (fs.existsSync(path.join(__dirname, "./views"))) {
    ...
    fs.writeFile(
      ...
      (err) => {
        ...
        // myEmitter.emit(
        //   "log",
        //   "init.createConfigText()",
        //   "INFO",
        //   "Created config text file."
        // );
      }
    );
    fs.writeFile(
      ...
      (err) => {
        ...
        // myEmitter.emit(
        //   "log",
        //   "init.createTokenText()",
        //   "INFO",
        //   "Created token text file."
        // );
      }
    );
  } else {
